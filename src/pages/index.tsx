...
import Modals from '../components/organisms/index/indexModal'
import ModalButtons from '../components/organisms/index/modalButtons'
  ...
  return (
    <Modals>
      <loadImageContext.Provider value={{ dispatch }}>
        <Loading
          loading={!loaded}
          loadingRate={Math.floor(loadingRate * 100)}
        />
